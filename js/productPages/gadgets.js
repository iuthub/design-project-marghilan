/* This .js file consists of my own codes that are used for gadgets.html
...
function ready(){
	...
	function menuForMobile(){
		mobileMenuItems.forEach((item)=>{
			...
			/* if 'item' from mobileMenuItems's array is 'gadgets'
			set class(materialize) and links to 'li' and 'a' tags */
			if (item.toLowerCase() === "gadgets"){
				li.setAttribute("class", "active");
				a.setAttribute("href", "gadgets.html");
	...
	/* This  function generates tabs for gadgets.html */
	function tabs(){
		...
		//for each element inside 'gadgetsItems' do...
		gadgetsItems.forEach((item)=>{
	...
	productGenerator(images, row1, "a&t");
	productGenerator(images2, row2, "a&t");
	productGenerator(images3, row3, "a&t");
	productGenerator(images4, row4, "a&t");
	productGenerator(images5, row5, "a&t");

/* This .js file consists of my own codes that are used for clothing.html
...
function ready(){
	...
	function menuForMobile(){
		mobileMenuItems.forEach((item)=>{
			...
			/* if 'item' from mobileMenuItems's array is 'clothing'
			set class(materialize) and links to 'li' and 'a' tags */
			if (item.toLowerCase() === "clothing"){
				li.setAttribute("class", "active");
				a.setAttribute("href", "clothing.html");
	...
	/* This  function generates tabs for clothing.html */
	function tabs(){
	...
	productGenerator(images, row1, "casual");
	productGenerator(images2, row2, "casual");
	productGenerator(images3, row3, "casual");
	productGenerator(images4, row4, "casual");
	productGenerator(images5, row5, "casual");
	productGenerator(images, row6, "sportwear");
	productGenerator(images2, row7, "sportwear");
	productGenerator(images3, row8, "sportwear");
	productGenerator(images4, row9, "sportwear");
	productGenerator(images5, row10, "sportwear");
	productGenerator(images, row11, "suits");
	productGenerator(images2, row12, "suits");
	productGenerator(images3, row13, "suits");
	productGenerator(images4, row14, "suits");
	productGenerator(images5, row15, "suits");

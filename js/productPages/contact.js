/* This .js file consists of codes that are used for contact.html
	...
	function menuRight(){
		menuItemsRight.forEach((item)=>{
			...
			if(item == "shopping_cart"){
				...
				i.innerHTML = item;
				a.appendChild(i);
			/* else if item is equal to 'contact', add materialize framework's

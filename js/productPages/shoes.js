/* This .js file consists of my own codes that are used for shoes.html
...
function ready(){
	...
	function menuForMobile(){
		mobileMenuItems.forEach((item)=>{
			...
			/* if 'item' from mobileMenuItems's array is 'shoes'
			set class(materialize) and links to 'li' and 'a' tags */
			if (item.toLowerCase() === "shoes"){
				li.setAttribute("class", "active");
				a.setAttribute("href", "shoes.html");
	...
	/* This  function generates tabs for shoes.html */
	function tabs(){
		...
		//for each element inside 'shoesItems' do...
	...
	productGenerator(images, row1, "boots");
	productGenerator(images2, row2, "boots");
	productGenerator(images3, row3, "boots");
	productGenerator(images4, row4, "boots");
	productGenerator(images5, row5, "boots");
	productGenerator(images, row6, "slippers");
	productGenerator(images2, row7, "slippers");
	productGenerator(images3, row8, "slippers");
	productGenerator(images4, row9, "slippers");
	productGenerator(images5, row10, "slippers");
	productGenerator(images, row11, "sneakers");
	productGenerator(images2, row12, "sneakers");
	productGenerator(images3, row13, "sneakers");
	productGenerator(images4, row14, "sneakers");
	productGenerator(images5, row15, "sneakers");
...
<div class="col s12 m6 l4">
	<div class="card">
		<div class="card-image">
			<img class="materialboxed" src="images/boots/1.jpg">
